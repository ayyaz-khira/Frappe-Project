...
def get_admin_stats():
    ...
    for org in orgs:
        # Count ALL entries in the members child table to reflect "occupied seats"
        # This ensures the count matches the directory list accurately.
        org.member_count = frappe.db.count("Org User Item", {"parent": org.name, "parenttype": "User Registration"})
        
        # Count how many of these members are actually enabled/active
